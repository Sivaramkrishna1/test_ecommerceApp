...
class AddCustomer:
    ...
    lstitemyourstorename_xpath = "//li[@id='71977536-b5c6-4d7b-a4ac-4077c295fef0']"
    ...
    def setNewsletter(self,role):
        ...
        if role == 'your store name':
            self.lstitem=self.driver.find_element_by_xpath(self.lstitemyourstorename_xpath)
        elif role == 'Test store 2':
            self.lstitem=self.driver.find_element_by_xpath(self.lstitemtestStore2_xpath)
